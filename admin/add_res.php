...
// print_r($stage);
// die();
  $sql="INSERT INTO `resourses`(`image`) VALUES ('$image')";
// print_r($sql);
// die();
       $result3 = db_query($sql);
      
    $msg = "Resourses Added Successfully.";
    setcookie("msg", $msg, time() + 3);
    print "<script>";
    print "self.location = 'add_res.php';";
    print "</script>";
    exit;
}
/* EDIT Template */
...
if ($_POST['stage'] == 3 && $_POST['rid'] != "") {
    ...
    $sql="UPDATE ` resourses` SET `image`='$image' WHERE id=" . $_POST['rid'] . "";
// print_r($sql);
// die();
  $result3 = db_query($sql);
  //include('pagemanipulate.php');
    ...
    setcookie("msg", $msg, time() + 3);
    print "<script>";
    print "self.location = 'mng_res.php';";
    print "</script>";
    exit;
}

if ($_GET['id'] != "") {
    $sql = "select * from  resourses where id=" . $_GET['id'] . "";
			...
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">ADD RESOURSES</li>
								</ol>
							</nav>
						</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">Add Resourses</h4>
						</div>
					</div>
					<div class="row">
						<div class=" col-sm-12">
