...
if ($stage == 2) {
    ...
    if ($_FILES['pimg']['name'] != "") {
        ...
        if (empty($is_valid)) {
            ...
            print "<script>";
            print "self.location = 'add_blog.php';";
            print "</script>";
            exit;
        } else {
...
// print_r($stage);
// die();
  $sql="INSERT INTO `blog`(`title`, `image`, `description`) VALUES ('$title','$image','$description')";
// print_r($sql);
// die();
...
if ($_POST['stage'] == 3 && $_POST['rid'] != "") {
    ...
    $sql="UPDATE `blog` SET `title`='$title',`image`='$image',`description`='$description' WHERE id=" . $_POST['rid'] . "";
// print_r($sql);
// die();
  $result3 = db_query($sql);
  //include('pagemanipulate.php');
    ...
    setcookie("msg", $msg, time() + 3);
    print "<script>";
    print "self.location = 'mng_blog.php';";
    print "</script>";
    exit;
}
                         ...
                         <?php } ?>
                          <!--message--> 
								<div class="form-group">
									...
									<input class="form-control" placeholder="Enter Blog Title" name="title" type="text"  value="<?php print $row['title'];?>" required>
								</div>
                                <div class="form-group">
                                    <label>Blog Description</label>
                                    <textarea  class="form-control" placeholder="Enter Blog Description" name="description" type="text"> <?php print $row['description'];?></textarea>
                                </div>
								<div class="form-group">
									<label>Image</label>
