...
if ($delid != ""){
    ...
    $upsql = "delete from banner where id={$delid}";            
...
?>
                                ...
                                <td><?php echo $i++;?></td>
									...
									<td><a href="add_ban.php?id=<?php echo $row['id'];?>"><i class="fas fa-edit" style="color:#000;"></i></a> |
