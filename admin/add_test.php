...
$feedback=$connect->real_escape_string($_POST['feedback']);
...
// print_r($stage);
// die();
  $sql="INSERT INTO `testimonial`( `name`, `feedback`,`image`) VALUES ('$name','$feedback','$image')";
// print_r($sql);
// die();
...
if ($_POST['stage'] == 3 && $_POST['rid'] != "") {
    ...
    $sql="UPDATE `testimonial` SET `name`='$name',`image`='$image',`feedback`='$feedback' WHERE id=" . $_POST['rid'] . "";
// print_r($sql);
// die();
  $result3 = db_query($sql);
  //include('pagemanipulate.php');
    ...
    setcookie("msg", $msg, time() + 3);
    print "<script>";
    print "self.location = 'mng_test.php';";
    print "</script>";
    exit;
}
			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">Add Testimonial</h4>
						</div>
					</div>
					<div class="row">
						<div class=" col-sm-12">
    ...
    <?php } ?>
      ...
      <!--message--> 
								<div class="form-group">
									...
									<input class="form-control" placeholder="Enter Name" name="name" type="text" value="<?php print $row['name'];?>" required>
								</div>
                                <div class="form-group">
                                    <label>Feedback</label>
                                    <input class="form-control" type="text" name="feedback" value="<?php print $row['feedback'];?>" required>
                                </div>
								<div class="form-group">
									<label>Image</label>
