...
if ($delid != ""){
    ...
    $upsql = "delete from resourses where id={$delid}";            
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Manage Resourses</li>
								</ol>
							</nav>
						</div>
...
$sqlfetch = "SELECT * FROM resourses";
...
?>
                                ...
                                <td><?php echo $i++;?></td>
									...
									<td><a href="add_res.php?id=<?php echo $row['id'];?>"><i class="fas fa-edit" style="color:#000;"></i></a> |
